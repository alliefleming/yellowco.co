...
"use strict";
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/allie/Sites/yellowco.co/node_modules/react/index.js'");
...
var _instagram = __webpack_require__(39);

var _instagram2 = _interopRequireDefault(_instagram);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _jquery2.default)('.nav-site .navbar-toggler').bigSlide({
  menu: '.nav-mobile',
  push: '.site-nav-push',
  side: 'right',
  easyClose: true
...
(0, _jquery2.default)('[data-href]').on('click', function (e) {
  window.location = (0, _jquery2.default)(e.currentTarget).data('href');
});

(0, _jquery2.default)('[data-toggle="tooltip"]').tooltip();

if (document.getElementById('instagram')) (0, _reactDom.render)(_react2.default.createElement(_instagram2.default, null), document.getElementById('instagram'));
...
"use strict";
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/allie/Sites/yellowco.co/node_modules/react-dom/index.js'");
...
var Instagram = function (_Component) {
  ...
  function Instagram(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Instagram.__proto__ || Object.getPrototypeOf(Instagram)).call(this, props));
  ...
  _createClass(Instagram, [{
    ...
    value: function componentWillMount() {
      ...
      _axios2.default.get('https://api.instagram.com/v1/users/self/media/recent?access_token=1116678100.6291bc8.b212a52780a3477bb68f956af87b7c56&client_id=6291bc814f1d4ed88014e701c86ff7b3').then(function (response) {
        _this2.setState({ images: response.data.data });
      }, function () {
    ...
    value: function render() {
      return _react2.default.createElement(
        'span',
        null,
        this.state.images.slice(0, 4).map(function (image) {
